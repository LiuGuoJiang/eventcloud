...
export class NoteServiceProxy {
    ...
    create(input: CreateNoteDto): Observable<NoteDto> {
        let url_ = this.baseUrl + "/api/services/app/Note/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: Response): Observable<NoteDto> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? NoteDto.fromJS(resultData200) : new NoteDto();
            return Observable.of(result200);
        } else if (status === 401) {
            const _responseText = response.text();
        ...
        return Observable.of<NoteDto>(<any>null);
    }
    ...
    publicNote(input: PublicNoteDto): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Note/PublicNote";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            return this.processPublicNote(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processPublicNote(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>Observable.throw(e);
                }
            } else
    ...
    protected processPublicNote(response: Response): Observable<void> {
        const status = response.status;
    ...
    update(input: UpdateNoteDto): Observable<NoteDto> {
        let url_ = this.baseUrl + "/api/services/app/Note/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: Response): Observable<NoteDto> {
        const status = response.status;
    ...
    getNote(id: number): Observable<PublicNoteDto> {
        let url_ = this.baseUrl + "/api/services/app/Note/GetNote?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PublicNoteDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<PublicNoteDto>><any>Observable.throw(response_);
        });
    }

    protected processGetNote(response: Response): Observable<PublicNoteDto> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PublicNoteDto.fromJS(resultData200) : new PublicNoteDto();
            return Observable.of(result200);
        } else if (status === 401) {
            const _responseText = response.text();
            return throwException("A server error occurred.", status, _responseText, _headers);
        ...
        return Observable.of<PublicNoteDto>(<any>null);
    }

    /**
     * @return Success
     */
    get(id: number): Observable<NoteDto> {
        let url_ = this.baseUrl + "/api/services/app/Note/Get?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
    ...
    protected processGet(response: Response): Observable<NoteDto> {
        const status = response.status;
     ...
     * @return Success
     */
    getAll(skipCount: number, maxResultCount: number): Observable<PagedResultDtoOfNoteDto> {
        let url_ = this.baseUrl + "/api/services/app/Note/GetAll?";
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfNoteDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfNoteDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<PagedResultDtoOfNoteDto> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfNoteDto.fromJS(resultData200) : new PagedResultDtoOfNoteDto();
            return Observable.of(result200);
        } else if (status === 401) {
            const _responseText = response.text();
            return throwException("A server error occurred.", status, _responseText, _headers);
        ...
        return Observable.of<PagedResultDtoOfNoteDto>(<any>null);
    }
    ...
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Note/Delete?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
...
export class PublicNoteDto implements IPublicNoteDto {
    des: string;
    img: string;
    tags: string;
    isPublic: boolean;
    ...
    constructor(data?: IPublicNoteDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PublicNoteDto {
        data = typeof data === 'object' ? data : {};
        let result = new PublicNoteDto();
        result.init(data);
        return result;
    }
...
export interface IPublicNoteDto {
    des: string;
    img: string;
    tags: string;
    isPublic: boolean;
...
export class PagedResultDtoOfNoteDto implements IPagedResultDtoOfNoteDto {
    totalCount: number;
    items: NoteDto[];

    constructor(data?: IPagedResultDtoOfNoteDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(NoteDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfNoteDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfNoteDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfNoteDto {
    totalCount: number;
    items: NoteDto[];
}
